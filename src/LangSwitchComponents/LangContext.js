...
/*Langprovider returns the current browsers language and save it in the providers state
  if default browser language and selected are different, the users choice will be
  taken.

*/
export function LangProvider(props) {
  console.log(window.localStorage.getItem("appUILang"))
